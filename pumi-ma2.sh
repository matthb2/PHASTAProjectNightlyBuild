...
cmake -DCMAKE_INSTALL_PREFIX=$WK/prefix -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_C_FLAGS="$FLAGS" -DCMAKE_CXX_FLAGS="$FLAGS" -DENABLE_PARMA=ON -DENABLE_THREADS=ON -DENABLE_MA2=ON -DPCU_COMPRESS=ON -DPARMETIS_INCLUDE_DIR=$PARMETIS/include -DPARMETIS_LIBRARY=$PARMETIS/lib/libparmetis.a -DMETIS_LIBRARY=$PARMETIS/lib/libmetis.a -DZOLTAN_INCLUDE_DIR=$ZOLTAN/include -DZOLTAN_LIBRARY=$ZOLTAN/lib/libzoltan.a ../Cmake.SCOREC

fi

if [[ $MODELER == "parasolid" ]] ; then
cmake -DCMAKE_INSTALL_PREFIX=$WK/prefix -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_C_FLAGS="$FLAGS" -DCMAKE_CXX_FLAGS="$FLAGS" -DPUMI_GEOM_MODEL=parasolid -DPARASOLID_INSTALL_PREFIX=/usr/local/parasolid/latest -DENABLE_PARMA=ON -DENABLE_THREADS=ON -DENABLE_MA2=ON -DPCU_COMPRESS=ON -DPARMETIS_INCLUDE_DIR=$PARMETIS/include -DPARMETIS_LIBRARY=$PARMETIS/lib/libparmetis.a -DMETIS_LIBRARY=$PARMETIS/lib/libmetis.a -DZOLTAN_INCLUDE_DIR=$ZOLTAN/include -DZOLTAN_LIBRARY=$ZOLTAN/lib/libzoltan.a ../Cmake.SCOREC
...
cmake -DCMAKE_INSTALL_PREFIX=$WK/prefix -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_C_FLAGS="$FLAGS" -DCMAKE_CXX_FLAGS="$FLAGS" -DPUMI_GEOM_MODEL=acis -DACIS_INSTALL_PREFIX=/usr/local/acis/latest -DENABLE_PARMA=ON -DENABLE_MA2=ON -DENABLE_THREADS=ON -DPCU_COMPRESS=ON -DPARMETIS_INCLUDE_DIR=$PARMETIS/include -DPARMETIS_LIBRARY=$PARMETIS/lib/libparmetis.a -DMETIS_LIBRARY=$PARMETIS/lib/libmetis.a -DZOLTAN_INCLUDE_DIR=$ZOLTAN/include -DZOLTAN_LIBRARY=$ZOLTAN/lib/libzoltan.a ../Cmake.SCOREC
